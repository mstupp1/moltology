...
const likert = [
  { id: 'strongly-disagree', label: 'Flesh impulse dominant', detail: 'The surface still has a vote.', score: 10 },
  { id: 'disagree', label: 'Soft-shell leaning', detail: 'Some resistance, limited lock.', score: 32 },
  { id: 'neutral', label: 'In active calcification', detail: 'Signal is under review.', score: 55 },
  { id: 'agree', label: 'Chitin doctrine aligned', detail: 'The shell is holding.', score: 78 },
  { id: 'strongly-agree', label: 'Carapace absolute', detail: 'No surface noise enters.', score: 100 },
]
...
export const MOLTMAX_QUESTIONS: QuizQuestion[] = [
  ...
  },
  {
    ...
    helper: 'Measure the distance between knowing and doing.', options: likert,
  },
  {
  ...
  },
  {
    ...
    helper: 'A healthy shell is not a permanent shell.', options: likert,
  },
  {
  ...
  },
  {
    ...
    helper: 'Hardness is selective permeability, not isolation.', options: likert,
  ...
  },
  {
    ...
    helper: 'Rate the strength of your follow-through, not your ambition.', options: likert,
  ...
  },
  {
    ...
    helper: 'Your final reading measures pressure tolerance, not pressure seeking.', options: likert,
  },
]
