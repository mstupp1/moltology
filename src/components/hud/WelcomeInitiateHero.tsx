...
export function WelcomeInitiateHero() {
  ...
  return (
    <>
      <div className="relative overflow-hidden bg-gradient-to-r from-[#0b1011]/85 via-[#0f1616]/85 to-[#0b1011]/85 backdrop-blur-md border-l-4 border-l-[#00ffff] border border-[#3a4a49] p-4 sm:p-5 chamfer-corner shadow-2xl transition-all duration-300 min-h-[108px] sm:min-h-[96px] flex flex-col justify-center">
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-4 font-mono">
          ...
          {isGuest && (
            <div className="flex items-center gap-3 pt-2 md:pt-0 border-t border-[#3a4a49]/50 md:border-t-0 md:border-l md:border-l-[#3a4a49]/50 md:pl-5 shrink-0">
              <span className="text-[11px] text-[#839493] font-mono tracking-wider uppercase">
                100% Free
              </span>
              <HudButton
                variant="crimson"
                ...
                className="font-mono text-xs uppercase font-bold tracking-wider whitespace-nowrap shadow-[0_0_15px_rgba(255,69,58,0.35)]"
              >
                SIGN UP
              </HudButton>
            </div>
