...
export const HUDHeader: React.FC<HUDHeaderProps> = ({
  ...
  return (
    <header className="w-full bg-[#020608]/90 backdrop-blur-md border-b border-[#00c3ff]/15 px-2.5 sm:px-4 py-1.5 sm:py-2 flex items-center gap-2 sm:gap-3 font-sans select-none relative z-30 shadow-[0_2px_20px_rgba(0,195,255,0.1)] shrink-0">
