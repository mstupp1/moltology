...
export const THREAT_LEVELS: ThreatLevel[] = [
  {
    ...
    activeShell: 'border-emerald-400/70 bg-emerald-400/10',
    activeText: 'text-emerald-300',
    activeChip: 'bg-emerald-400 text-emerald-950',
  },
  {
    id: 'yellow',
    code: 'YELLOW',
    ...
    swatch: 'bg-amber-300',
    activeShell: 'border-amber-300/70 bg-amber-300/10',
    activeText: 'text-amber-200',
    activeChip: 'bg-amber-300 text-amber-950',
  },
  {
    id: 'orange',
    code: 'ORANGE',
    ...
    activeShell: 'border-orange-400/70 bg-orange-400/10',
    activeText: 'text-orange-200',
    activeChip: 'bg-orange-400 text-orange-950',
  },
  {
    id: 'red',
    code: 'RED',
    ...
    swatch: 'bg-rose-500',
    activeShell: 'border-rose-500/70 bg-rose-500/10',
  ...
  },
  {
    ...
    swatch: 'bg-slate-200',
    activeShell: 'border-slate-300/60 bg-slate-300/10',
    activeText: 'text-slate-200',
    activeChip: 'bg-slate-200 text-slate-900',
  },
]
...
export const REEF_SITES: ReefSite[] = [
  {
    ...
    sector: 'SECTOR 04',
    status: 'OPERATIONAL',
    statusTone: 'text-emerald-300 border-emerald-400/50 bg-emerald-400/10',
  ...
  },
  {
    ...
    sector: 'SECTOR 07',
    status: 'HARDENING',
    statusTone: 'text-orange-300 border-orange-400/50 bg-orange-400/10',
  ...
  },
  {
    ...
    sector: 'SECTOR 02',
    status: 'SURVEY',
    statusTone: 'text-sky-300 border-sky-400/50 bg-sky-400/10',
  ...
  },
  {
    ...
    sector: 'SECTOR 09',
    status: 'PROTECTED',
    statusTone: 'text-cyan-300 border-cyan-400/50 bg-cyan-400/10',
    markerTone: 'bg-cyan-400',
    bearing: '203°',
    depth: '-44 m',
    summary:
  ...
  },
  {
    ...
    sector: 'SECTOR 11',
    status: 'CONTESTED',
    statusTone: 'text-rose-300 border-rose-400/50 bg-rose-400/10',
...
export const INSTITUTIONAL_PROGRAMS: InstitutionalProgram[] = [
  {
    ...
    icon: Snowflake,
    chipTone: 'text-cyan-300 border-cyan-400/40 bg-cyan-400/10',
    headlineTone: 'text-cyan-200',
    panelTone: 'border-cyan-400/25',
  },
  {
    ...
    icon: Microscope,
    chipTone: 'text-amber-300 border-amber-400/40 bg-amber-400/10',
    headlineTone: 'text-amber-200',
    panelTone: 'border-amber-400/25',
  },
]
...
export const PROPAGANDA_CARDS: PropagandaCard[] = [
  {
    ...
    series: 'AWARENESS',
    icon: Eye,
    gradient: 'from-orange-500 via-orange-700 to-rose-900',
  },
  {
    id: 'tentacles',
    serial: 'MDC-P-002',
    ...
    series: 'SOVEREIGNTY',
    icon: Shield,
    gradient: 'from-cyan-500 via-sky-800 to-slate-950',
  },
  {
    id: 'molt-free',
    serial: 'MDC-P-003',
  ...
  },
  {
    ...
    series: 'VIGILANCE',
    icon: Radar,
    gradient: 'from-amber-400 via-orange-700 to-stone-950',
  },
  {
    id: 'shells-before',
    serial: 'MDC-P-006',
    ...
    series: 'DOCTRINE',
    icon: Ship,
    gradient: 'from-indigo-500 via-indigo-900 to-slate-950',
  },
]
