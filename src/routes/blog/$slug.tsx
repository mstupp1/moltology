...
export const Route = createFileRoute('/blog/$slug')({
  ...
  head: ({ loaderData }) => ({
    meta: [
      { title: `${loaderData?.title ?? 'Transmission'} | Moltology Blog` },
      ...
      <div className="min-h-screen bg-[#070b0b] text-gray-200 font-mono flex flex-col justify-between items-center py-20">
        ...
        <div className="text-center chitin-card border border-red-900/60 p-12 chamfer-corner max-w-lg">
          ...
          <p className="text-xs text-gray-400 mt-2 mb-6">
            The requested transmission slug does not exist or has been redacted by the Benthic Core.
          </p>
          <Link
            to="/blog"
      ...
      <article className="flex-1 w-full relative z-10">
        <header className="w-full relative py-12 sm:py-20 px-6 sm:px-12 border-b border-cyan-900/50 bg-[#040708] overflow-hidden">
          <div className="max-w-4xl mx-auto space-y-6">
            ...
            >
              <ArrowLeft className="w-4 h-4" />
              <span>BACK TO SYNAPTIC CHRONICLES</span>
            </Link>
