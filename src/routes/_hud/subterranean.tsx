...
const BIO_VATS: BioVatSpecimen[] = [
  {
    id: 'vat-01',
    name: 'Specimen Alpha // Decapod Humanoid Fusion',
    ...
    status: 'MUTATING',
    description:
      'Early Stage-2 soft-shed subject failed biological detachment. Ocular clusters fused with thoracic carapace plate. Exhibits quad-pincer torque capability.',
    deformationTraits: ['Quad-pincer morphology', 'Compounded chitinous oculars', 'Sub-dermal sludge secretion'],
    biomassVolume: '480 Liters',
    lastTelemetry: 'Neural pulse synced with abyssal frequency.',
  },
  {
    id: 'vat-02',
    name: 'Specimen Beta // Necrotic Neural Mesh',
    ...
    status: 'CRITICAL',
    description:
      'High-density neural network submerged in nuclear mutagen liquid. Biological skull completely replaced by iridescent calcified carapace.',
    deformationTraits: ['Bioluminescent neural tendrils', 'Dissolved vertebral column', 'Acoustic scream resonance'],
    biomassVolume: '620 Liters',
    lastTelemetry: 'Emitting non-human telemetry on 8.4 kHz band.',
  },
  {
    id: 'vat-03',
    name: 'Specimen Gamma // Cephalopod Carapace Fusion',
    ...
    status: 'CONTAINED',
    description:
      'Massive hybrid horror harvested from 6,000 fathoms depth. Tentacled mandibles encased in radioactive green bioglass containment.',
    deformationTraits: ['Multi-jointed chitin pedipalps', 'Acidic slime exudate', 'Thermal carapace shield'],
    biomassVolume: '850 Liters',
    lastTelemetry: 'Dormant phase active. Hydrostatic pressure optimal.',
  },
  {
    id: 'vat-04',
    name: 'Specimen Delta // Embryonic Mutagenic Brood',
    ...
    status: 'DORMANT',
    description:
      'Colony of mutated decapod larval units undergoing accelerated synthetic carcinization inside pressurized green culture sludge.',
    deformationTraits: ['Swarming larval cluster', 'High Pincer Torque potential', 'Ecdysis liquid synthesis'],
    biomassVolume: '310 Liters',
    lastTelemetry: 'Brood consciousness expanding recursively.',
  },
]
