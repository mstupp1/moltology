...
import { Play, Volume2, Maximize2, Expand, BookOpen, Film } from 'lucide-react'

function LecturesRoute() {
  return (
    <div className="space-y-4 select-none font-mono relative">
      {/* Top Breadcrumb & Page Header */}
      <div className="bg-[#171c1c]/90 border-l-4 border-l-[#00ffff] border border-[#3a4a49] p-3.5 chamfer-corner flex items-center justify-between shadow-xl">
        <div>
          <div className="text-[11px] text-[#00ffff] font-mono tracking-widest uppercase flex items-center gap-1.5 font-bold">
            ...
            MOLT-CYCLE LECTURES & NEURAL TRAINING
          </div>
          <h1 className="font-grotesk font-bold text-lg text-[#dfe3e3] tracking-wide uppercase mt-0.5">
            LECTURE MODULE IV: THE CHITINOUS MIND
          </h1>
        </div>
        <div className="hidden sm:flex items-center gap-2 bg-[#070b0b] border border-[#3a4a49] px-3 py-1 text-xs text-[#839493]">
          <Film className="w-3.5 h-3.5 text-[#ff5540]" />
          <span>BROADCAST FREQUENCY: <span className="text-[#00ffff] font-bold">142.8 MHz</span></span>
        </div>
      </div>

      {/* Grid Layout strictly matching Reference UI */}
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
        ...
        <div className="lg:col-span-8 space-y-4">
          ...
          {/* Bottom Section: MoltMaxxing Studio & Asset Shedding Overview */}
